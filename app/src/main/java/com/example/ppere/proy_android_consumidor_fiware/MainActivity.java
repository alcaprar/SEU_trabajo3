...
// thread para almacenar la IP asignada
    ...
    // hilo de subscripción se crea y se queda dormido esperando conexiones la IP debe ser pública o accesible
        ...
        //                String g=addr.getHostAddress();
                            ...
                            while (!sk.isClosed()) {
                                ...
                                //TAREA III leerdatos enviados por el contextBroker
                                ...
                                try {
                                    ...
                                    //TAREA III parsing json y actualización de la UI
    ...
    class QueryContextTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            String payload = "{\"entities\": [{\"type\": \"sensoractuator\",\"isPattern\": \"false\",\"id\": \"" + device_name + "\"}], \"attributes\":[\"temperature\"]}";
            String leng = null;
            String resp = "none";
            imprimirln(payload);
            if (usertoken.length() == 0) {
    ...
    class subscribeContextTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            // TAREA III
            String payload = "aqui poner la subscripción";
    ...
    class updateLEDContextTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... urls) {
            ...
            String led_values = LED1_ST + LED2_ST + LED3_ST + LED4_ST;
